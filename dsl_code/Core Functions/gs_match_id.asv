...
% gs_match_id(E_genes,gene_names,geneset_defs_file)
...
%     X_multiple(i,:) = sum(X_sorted(multiple(i,1):multiple(i,2),:),1); 
end
...
for i = 1:M
    ...
    g_multiple = strtrim(regexp(cell2mat(strcat(g_m(multiple),'///')),'///','split')); 
