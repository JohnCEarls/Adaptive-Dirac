function [mu_R_1,mu_R_2,mu_diff_gs,mu_diff_stats,chi_R] = mu_diff(gs_struct,groups,num_permut)
...
mu_diff_stats = flipud(...
    [keep_gs(sort_idx),mu_diff_G_gs,mu_diff_G_pairs,mu_diff,mu_diff_pvals]);
