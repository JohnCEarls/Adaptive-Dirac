...
% note: indices into gs_seed, gs_sffs, eta_seed, eta_sffs are all
...
output_dir = char(strcat(int2str(num_networks), 'n', int2str(num_iterations), 'i', ...
...
output_dir = char(strcat('../dsl_results/',dataset,'/', output_dir));
