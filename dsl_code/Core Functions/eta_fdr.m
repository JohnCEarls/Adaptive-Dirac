function [eta_gs,eta_stats] = eta_fdr(gs_struct,groups,num_permut)
% num_permut = 1;
...
[R_1,R_2,T_train] = rank_matching(X,g_gs_idx,'train',groups);
...
%display(['Eta FDR ' num2str(100*p/num_permut) '% Complete (' num2str(p) '%permutations)'])
%toc
