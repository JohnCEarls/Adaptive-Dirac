function [mu_R_1_gs,mu_R_1_stats,mu_R_2_gs,mu_R_2_stats] = mu_R(gs_struct,groups)
...
mu_R_1_stats = flipud(...
    [keep_gs(R_1_sort_idx),mu_R_1_G_gs,mu_R_1_G_pairs,mu_R_1]);
mu_R_2_stats = flipud(...
    [keep_gs(R_2_sort_idx),mu_R_2_G_gs,mu_R_2_G_pairs,mu_R_2]);
